            ...
            <div className="flex shrink-0 items-center gap-1 sm:gap-1.5">
              {syncStatus !== 'idle' && (
                ...
                >
                  ...
                  {syncStatus === 'ok' && (
                    <svg className="h-4 w-4 text-[var(--success)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                  )}
                  {syncStatus === 'error' && (
                    <svg className="h-4 w-4 text-[var(--destructive)]" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
